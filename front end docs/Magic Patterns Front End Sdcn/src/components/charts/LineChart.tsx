  ...
  return <div className={`w-full ${className}`}>
      ...
      <ResponsiveContainer width="100%" height={height}>
        ...
        bottom: 50
          ...
          <YAxis domain={[0, 100]} label={yAxisLabel ? {
          value: yAxisLabel,
          angle: -90,
          position: 'insideLeft',
          offset: 10
          ...
          <Legend />
          {lines.map((line, index) => <Line key={index} type="monotone" dataKey={line.dataKey} stroke={line.color} name={line.name || line.dataKey} activeDot={{
          r: 8
        }} strokeWidth={2} />)}
        </RechartsLineChart>
      </ResponsiveContainer>
